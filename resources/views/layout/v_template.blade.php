...
<html
  ...
  data-assets-path="{{asset('template/')}}{{asset('template/')}}/assets/"
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="/" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">Fresh Forever</span>
            </a>
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="/training" class="menu-link">
                    <div data-i18n="Without navbar">Data Training</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="/prediksi" class="menu-link">
                    <div data-i18n="Container">Prediksi</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="/hasil" class="menu-link">
                    <div data-i18n="Fluid">Hasil</div>
                  </a>
                </li>
                <!-- <li class="menu-item">
            ...
            <footer class="content-footer footer bg-footer-theme">
              <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                <div class="mb-2 mb-md-0">
                  ...
                  , by
                  <a href="https://themeselection.com" target="_blank" class="footer-link fw-bolder">Nitis Weka</a>
                </div>
                <div>
